    ...
    >
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 flex flex-col items-center">
            <h2 className="text-5xl md:text-5xl font-bold mb-12">
              <div className="text-[#2ED9FF] flex items-baseline">
                <img src={question} alt="Question Icon" className="w-8 h-8" />
          ...
          <div className="grid w-full gap-10 md:grid-cols-2 lg:grid-cols-1">
            <div data-aos="fade-right" className="flex items-center gap-6 md:items-end w-full">
              <div className="flex gap-6 w-3/4 bg-[#181818]/60 p-4 rounded-lg border border-[#474747]">
                <img
                  src={trabalho}
        ...
        <div className="relative z-10">
          <div className="p-8 mt-16 text-center text-white text-lg leading-relaxed">
            <h2 className="text-4xl w-full font-bold flex justify-center text-[#2ED9FF]">
              <span className="w-2/3">São habilidades comportamentais e emocionais que influenciam tudo ao seu redor.</span>
            </h2>
            <p className="mt-2">
